...
- [x] 사이드바의 MVP 사용자 데이터 입력 확장
- [x] 투자성향 설문형 입력 추가
- [x] 관심 섹터를 반도체/금융 중심으로 제한
- [x] 보유 종목 수동 입력 UI 추가
- [x] 현금 비중 입력 유지
- [x] 질문 입력과 분석 실행 흐름 유지
- [x] 입력값 검증 메시지 추가

### Phase 5. Curator 개선

- [x] 질문에서 종목명/종목코드 추출
- [x] 보유 종목 안에서 먼저 target 매칭
- [x] 질문에 종목이 없으면 포트폴리오 전체 점검으로 분류
- [x] 선호 섹터 기반 후보 추천
- [x] MVP 지원 산업 밖이면 warning 반환
- [x] 애매한 질문은 candidates로 넘기고 임의 확정하지 않기
